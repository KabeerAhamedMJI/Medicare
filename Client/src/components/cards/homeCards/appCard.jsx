...
const appCard = () => {
    return (
        <div className='container flex flex-col md:flex-row mt-8 md:mt-16 gap-6'>
            <div className='flex flex-col w-full md:w-1/2 bg-[#E0ECE7] rounded-2xl shadow pt-12 flex items-center'>
            ...
            <div className='bg-[#eae4dc] w-full md:w-1/2 rounded-2xl shadow flex flex-col lg:flex-row items-center justify-between p-4 md:p-0'>
