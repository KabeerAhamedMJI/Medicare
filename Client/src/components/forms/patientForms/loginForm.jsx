      ...
      <div className="flex justify-center items-center px-5 lg:px-0">
        <div className="max-w-screen-xl md:flex bg-white sm:rounded-lg flex flex-1">
          <div className="hidden md:flex flex-1 justify-center">
            <div>
              <img className="w-auto" src={Hospital} alt="Logo" />
            </div>
          </div>
          <div className="xl:w-5/12 p-6 sm:p-12 lg:mt-6">
            <div className="card bg-base-100 w-full max-w-sm shrink-0 shadow-2xl border-2">
              <form onSubmit={handleSubmit(onSubmit)} className="card-body">
                <div className="form-control">
                  ...
                  <input type="text" {...register("emailOrMobile")} placeholder="Mobile Number / Email ID" className="input input-bordered" required />
                </div>
                <div className="form-control">
                  <label className="label">
